...
# Using:
You can either run it from the CMD with CLI commands for both the pooling rate and the DPI `--250 --1600` or directly, in which case you can input the chosen values. Only a limited amount of DPIs and Pooling Rates are availible due to the firmware being very strict about which hex values are acceptable. 
